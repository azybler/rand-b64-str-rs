...
#[inline(always)]
pub fn get_u32() -> String {
    use strength_reduce::StrengthReducedU32;
    get!(u32, 6, StrengthReducedU32::new)
}
...
mod tests {
    ...
    fn b10_to_b64_u32_test() {
        ...
        let tests = &[
            ...
            (63, "_".to_string()),
            (64, "10".to_string()),
            (u32::MAX / 2, "1_____".to_string()),
            (u32::MAX - 1, "3____-".to_string()),
            (u32::MAX, "3_____".to_string()),
        ];
        for (input, want) in tests {
            let got = b10_to_b64!(*input, 11, StrengthReducedU32::new);
            assert_eq!(got, *want);
        }
    }
    ...
    fn b10_to_b64_u64_test() {
        ...
        let tests = &[
            ...
            (63, "_".to_string()),
            (64, "10".to_string()),
            (u64::MAX / 2, "7__________".to_string()),
    ...
    fn b10_to_b64_u128_test() {
        ...
        let tests = &[
            ...
            (63, "_".to_string()),
            (64, "10".to_string()),
            (u128::MAX / 2, "1_____________________".to_string()),
